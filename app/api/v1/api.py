...
from app.api.v1.endpoints import ai, appsec, appsec_intel, arena, auth, infrasec, lab, system, terminal, users
...
api_router.include_router(appsec_intel.router, prefix="/appsec/intel", tags=["appsec-intel"])
